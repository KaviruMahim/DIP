...
class ImageProcessorApp:
    ...
    def segment_image(self):
        if hasattr(self, 'image'):
            ...
            # Initialize a blank image for the segmented output
            ...
            for color_name, (lower, upper) in colors.items():
                ...
                segmented_image[mask > 0] = self.image[mask > 0]
    ...
    def display_segmented_image(self, segmented_image):
        if segmented_image is not None:
            ...
            img_pil = Image.fromarray(segmented_image_rgb)
            self.tk_segmented_image = ImageTk.PhotoImage(image=img_pil)
            self.image_label.configure(image=self.tk_segmented_image)
